        ...
        args = {
            ...
            visibility = {
                ...
                args = {
                    ...
                    maxMinimapDistance = { type = "range", name = "Max Minimap Distance", desc = "Maximum distance from player to show minimap icons. 0 = unlimited. Distance is in yards (approximate, varies by zone).", order = 6, min = 0, max = 2000, step = 50, get = function() return L.db.profile.mapFilters.maxMinimapDistance or 0 end, set = function(_, val) L.db.profile.mapFilters.maxMinimapDistance = val; refreshUI() end, },
