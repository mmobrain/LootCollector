...
Description:
	...
	automatically.  
Modified By: Skulltrail
Modification purpose: Added Ascension starter zone data @ 2025-10.28
...
local LIBRARY_VERSION_MINOR = tonumber(string.match("$Revision: 109 $", "(%d+)") or 1)
